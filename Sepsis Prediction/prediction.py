...
for num_hrs in list((4,6)):
	...
	plt.plot(fraction_of_positives, mean_predicted_value, 'r--')
	print('\n\n')
	...
	prob_pos = (prob_pos - prob_pos.min()) / (prob_pos.max() - prob_pos.min())
	fraction_of_positives, mean_predicted_value = calibration_curve(Y_test, prob_pos, n_bins=10, normalize=True)
	plt.plot(fraction_of_positives, mean_predicted_value, 'g*')
	print('\n\n')
	...
	prob_pos = (prob_pos - prob_pos.min()) / (prob_pos.max() - prob_pos.min())
	fraction_of_positives, mean_predicted_value = calibration_curve(Y_test, prob_pos, n_bins=10, normalize=True)
	plt.plot(fraction_of_positives, mean_predicted_value, 'c-')
	print('\n\n')
